...
const getBackgroundImage = (quadrantId: string) => {
  const images: Record<string, string> = {
    'urgent-important': '/src/images/do.png',
    'urgent-not-important': '/src/images/delegate.png',
    'not-urgent-important': '/src/images/schedule.png',
    'not-urgent-not-important': '/src/images/delete.png'
  };
